...
public class Fish2_Api : MonoBehaviour
{
    ...
    void awake()
    {
         ...
         Fish2 = GetComponent<Animator>();
         FISH2 = GameObject.FindGameObjectWithTag("Fish");
    } 
    ...
    void Update()
    {
        height = floatTemp;
         ...
         {
             Right = true;
             Fish2.SetBool("Left", false);
             Fish2.SetBool("Right", true);
         }

         if (transform.position.x >= 7.5)
         {    
             Right = false;
             Fish2.SetBool("Right", false);
             Fish2.SetBool("Left", true);
         }
    ...
    {
        FISH2.transform.position = fishPos;
